                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <File
                                        ...
                                        :current="postData.fields[field.identifier]"
                                        class="col-md-4"
                                        :name="field.identifier"
                                        type="file"
                                        :min="field.min"
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <File
                                    ...
                                    :value.sync="postData.seo.image[locale]"
                                    :current="postData.seo.image[locale]"
                                    class="col-md-4"
...
export default {
    ...
    async mounted() {
        const data = (await http.get('posts/' + this.$route.params.postId + '/show')).data.result;
        this.fields = (await http.get('posts/' + this.$route.params.postType + '/fields')).data.result

        this.postData.fields = data.fields
        this.postData.seo = data.seo

    },

    methods: {
        async save() {
            await http.put('posts/' + this.$route.params.postId, {
                ...this.postData,
